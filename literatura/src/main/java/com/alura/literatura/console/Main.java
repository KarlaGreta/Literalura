    ...
    public void buscarLibroWeb() {
        ...
        try {
            ...
            Optional<DataBook> libroBuscado = datosApi.libros().stream()
                    .filter(l -> l.titulo().toLowerCase().equalsIgnoreCase(tituloBuscado.toLowerCase()))
                    .findFirst();
